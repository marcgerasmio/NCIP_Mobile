            ...
            <Col xs={12} md={4} className="mb-4">
                <div className="text-center">
                  ...
                  <Card.Text className="text-muted mb-1">
                    {userdata.position ? userdata.position : "null"}
                  </Card.Text>
                  ...
                  <div className="d-flex gap-1 justify-content-center">
                    ...
                    <Button className="p-2 buttons font fw-bold" onClick={logout}>
                      <TbLogout size={20} className="me-1 mb-1" />
                      Logout
                    </Button>
                  </div>
                </div>
              ...
              <Card className="mb-4 shadow">
                <Card.Body>
                  ...
                  <Row>
                    ...
                    <Col xs={8} sm={9}>
                      <p className="text-muted mb-0">
                        {userdata.religion ? userdata.religion : "null"}
                      </p>
                    </Col>
                  </Row>
                  <hr />
                  <Row>
                    ...
                    <Col xs={8} sm={9}>
                      <p className="text-muted mb-0">
                        {userdata.blood_type ? userdata.blood_type : "null"}
                      </p>
                    </Col>
                  </Row>
                </Card.Body>
        ...
        <Modal show={showModal} onHide={handleClose} className="text" centered>
          ...
          <Modal.Body style={{ maxHeight: "80vh", overflowY: "auto" }}>
              ...
              <Card className="shadow">
                <Card.Body className="text-center">
                  ...
                  <div className="d-flex justify-content-center align-items-center mt-3">
                    <p className="text text-muted fst-italic">
                      *Tap the image to change photo
                    </p>
                  </div>
                </Card.Body>
              </Card>
            ...
            <Form className="text">
              ...
              <Button
                className="w-100 fw-bold login-btn font mt-2"
                variant="primary"
                onClick={update}
              >
                Save Changes
